...
(function(){
  ...
  function loadScript(src,cs){return new Promise(function(res,rej){var s=document.createElement('script');if(cs)s.charset=cs;s.src=src;var t=setTimeout(function(){s.remove();rej('timeout');},9000);s.onload=function(){clearTimeout(t);s.remove();res();};s.onerror=function(){clearTimeout(t);s.remove();rej('err');};document.head.appendChild(s);});}
